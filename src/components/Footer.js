			...
			<footer>
				<div className='main-footer inner-container'>
					...
					<div className='footer-two' style={{marginTop: '20px'}}>
						<q style={{fontSize: '16px', paddingBlock: '1rem'}}>A society grows great when old men plant trees in whose shade they shall never sit in.</q><cite style={{fontSize: '16px', paddingBlock: '1rem'}}> -Greek Proverb</cite>
						<h3>Disclaimer</h3>
